...
This module can be shared across all agents.
"""
...
merge_research_results = format_all_notes  # Alias
extract_unique_urls = deduplicate_sources  # Conceptual alias
create_search_summary = format_sources  # Conceptual alias
validate_extracted_data = calculate_completeness  # Conceptual alias
calculate_confidence_score = calculate_completeness  # Alias
